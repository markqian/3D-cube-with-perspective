//---------------------------------------------------------------------------
//
// algebra.hpp -- Introduction to Computer Graphics
//
...
inline Vector4D operator -(const Vector4D& s, const Vector4D& v)
{
  return Vector4D(s[0] - v[0], s[1] - v[1], s[2] - v[2], s[3] - v[3]);
}
